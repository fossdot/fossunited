<template>
  <div v-if="event.data" class="w-full z-0">
    <EventHeader v-if="event.doc" :event="event.doc" class="p-4 md:p-8" />
...
const tabs = [
  { label: 'Manage', route: `/event/${route.params.id}/merch` },
  { label: 'Insights', route: `/event/${route.params.id}/merch/insights` },
]
</script>
